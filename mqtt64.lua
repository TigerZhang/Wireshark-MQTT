...
do
	...
	MQTTPROTO = Proto("MQTT64", "MQ Telemetry Transport with 64bit mid")
	...
	f.publish_message_id = ProtoField.uint64("mqtt.publish.message_id", "Message ID")
	f.publish_data = ProtoField.string("mqtt.publish.data", "Data")

	-- Subscribe
	f.subscribe_message_id = ProtoField.uint64("mqtt.subscribe.message_id", "Message ID")
